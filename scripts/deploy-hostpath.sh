...
echo -e "${BLUE}=== Deploying with hostPath in Lima VM ===${NC}"
...
echo -e "${BLUE}=== Deploying with hostPath inside Lima VM ===${NC}"
...
sudo mkdir -p /tmp/flintlock-data
sudo chmod 777 /tmp/flintlock-data
