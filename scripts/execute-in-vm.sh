...
# Let the flintlock server handle the execution
echo -e "${YELLOW}Waiting for flintlock to execute the code in VM...${NC}"
# Wait for the flintlock server to process the request
sleep 5
